        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
          {montessoriPrinciples.map((item) => (
            <div key={item.key} className="p-8 bg-white dark:bg-gray-900 rounded-lg shadow-md">
              <div
                className={`${colorClasses[item.color as ColorKey].bg} rounded-full w-16 h-16 flex justify-center items-center ${colorClasses[item.color as ColorKey].text} shadow-2xl`}
              >
                <svg
              ...
              <h2 className={`uppercase mt-6 ${colorClasses[item.color as ColorKey].text} font-medium mb-3`}>
                {item.title}
              </h2>
              ...
              <Link
                ...
                className={`${colorClasses[item.color as ColorKey].text} flex items-center ${colorClasses[item.color as ColorKey].hoverText}`}
              >
